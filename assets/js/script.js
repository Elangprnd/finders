...
function validatePasswordChange() {
    ...
    const konfirmasiPassword = document.getElementById('konfirmasi_password_baru');
    
    if (!passwordBaru || !konfirmasiPassword) {
        return true; // Elements don't exist, let server handle it
    }
